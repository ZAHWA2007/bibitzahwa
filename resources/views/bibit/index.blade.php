...
<div class="card card-info"> 
        <div class="card-header"> 
            <h2 class="card-title">Data bibit</h2> 
            <a type="button" class="btn btn-success float-right" href="{{ route('bibit.create') }}"> 
                    ...
                    <tr> 
                        ...
                        <td> 
                            <div class="btn-group"> 
                                ...
                                <a type="button" class="btn btn-warning" href="{{ route('bibit.edit',$dt->id) }}"> 
                                    <i class=" fas fa-edit"></i> 
                                </a> 
                                <a type="button" class="btn btn-success" href="{{ route('bibit.show',$dt->id) }}"> 
